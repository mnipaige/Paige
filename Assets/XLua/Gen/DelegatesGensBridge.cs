...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public LuaLoader.addDelegate __Gen_Delegate_Imp12()
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
                ...
                LuaLoader.addDelegate __gen_ret = translator.GetDelegate<LuaLoader.addDelegate>(L, errFunc + 1);
                LuaAPI.lua_settop(L, errFunc - 1);
                return  __gen_ret;
#if THREAD_SAFE || HOTFIX_ENABLE
            }
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(LuaLoader.addDelegate))
			{
			    return new LuaLoader.addDelegate(__Gen_Delegate_Imp11);
			}
		
		    if (type == typeof(LuaLoader.GetPaigeAge))
			{
			    return new LuaLoader.GetPaigeAge(__Gen_Delegate_Imp12);
			}
