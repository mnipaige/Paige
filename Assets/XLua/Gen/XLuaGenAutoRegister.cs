...
namespace XLua.CSObjectWrap
{
    public class XLua_Gen_Initer_Register__
	{
        ...
        static void wrapInit0(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(Animal), AnimalWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(Dog), DogWrap.__Register);
        ...
        static void Init(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.AddInterfaceBridgeCreator(typeof(LuaLoader.IPaige), LuaLoaderIPaigeBridge.__Create);
